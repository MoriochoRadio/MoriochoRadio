...
학교 밖에서도 **혼자서** 기획·구현·배포까지 끝냅니다. 의료 AI를 단독으로 연구해 **논문까지 작성**했고, 그 외에도 여러 분야의 제품을 **AI·자동화로 실제 동작하게** 만들어 왔습니다.

### 🔬 대표 솔로작 — AI-CASA · AI 기반 정자 종합 분석 시스템 ([sperm-ai](https://github.com/MoriochoRadio/sperm-ai))

> **SEED 팀 캡스톤보다 먼저, 혼자서 웹까지 완성한 의료 AI 프로젝트.** 이 단독 연구를 바탕으로 **논문을 작성**했습니다. *(제출 완료 · 학술대회 발표 대기 중)*
