...
**병원정보시스템(HIS)·의료IT 분야를 목표로 하는 개발자** · 건양대학교 의료IT공학과 재학

의료 현장의 문제를 딥러닝과 웹으로 푸는 일을 해왔습니다.
학회 논문 2편을 썼고, 그중 의료영상 AI 주제는 1인 연구와 졸업 팀 캡스톤으로 각각 끝까지 구현했습니다.
산학협력 과제에서는 데이터 수집·정의 파트를 맡아 실제 제조 현장의 데이터셋을 설계했습니다.
...
## 개인 프로젝트 — AI를 도구로 쓰는 연습

아래는 **LLM과 AI 에이전트를 실제 제품에 엮어내는 훈련**을 목적으로 만든 것들입니다.
