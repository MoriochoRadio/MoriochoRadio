...
> **다양한 헬스케어·케어 도메인의 문제를 AI 와 앱으로 풀어보는 의료IT 개발자 지망생**

건양대학교 **의료IT공학과** 에서 의료와 기술이 만나는 지점을 공부하고 있습니다. 환자 대기 시간, 어린이 안전, 독거노인 모니터링, 폐·간 CT 결절 탐지까지 — *"의료진뿐 아니라 사람(환자) 본인을 위한 도구"* 를 만드는 데 관심이 있습니다.

**주 관심 분야** 🏥 의료IT · 병원정보시스템(HIS) · 의료영상 AI
**기반 관심** 그 바탕이 되는 소프트웨어공학과 생성형 AI
...
학부 팀 프로젝트를 통해 **헬스케어·케어 도메인** 의 문제들을 하나씩 풀어 왔습니다. 앱·IoT 에서 시작해 의료영상 AI 로 이어지는 흐름입니다.
...
모델     3D Voxel CNN (4-branch)     →     3D Mesh + SpiralNet+PointNet+Transformer
정확도   78%                         →     93%  (+15%p)
...
마지막 학기 캡스톤 [seed-project](https://github.com/MoriochoRadio/seed-project) 와 [sperm-ai](https://github.com/MoriochoRadio/sperm-ai) (AI 정자 운동성 분석) 로 의료영상 AI 경험을 이어가고 있습니다. 졸업 후 **의료IT·병원정보시스템** 분야에서 일하는 것을 목표로 하고 있습니다.

---

### 📫 연락

GitHub: [@MoriochoRadio](https://github.com/MoriochoRadio)
